...
plt.savefig('/home/bing/Dropbox/work/code/repos/icAnalyzer/figures/mean_std.png', bbox_inches='tight')
plt.close('all')
plt.ion()
...
plt.savefig('/home/bing/Dropbox/work/code/repos/icAnalyzer/figures/naive_PCA.png', bbox_inches='tight')
plt.close('all')
plt.ion()
